...
class Report:
    def __init__( self, interval):
        ...
        self.elapsed = 0
    def report( self, s):
        self.elapsed += ( time.perf_counter() - self.lastTime)
...
ai1Spaceship = AI1Spaceship( "spaceship2.bmp", AI1StartLoc, 0,
                                 Velocity( 0, 0), startFinishLine,
                                 trackPointsList)
ai2Spaceship = AI2Spaceship( "spaceship3.bmp", AI2StartLoc, 0,
                                   Velocity( 0, 0), startFinishLine,
                                   trackPointsList)
