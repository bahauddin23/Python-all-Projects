...
weight=Label(root,text="WEIGHT",borderwidth=1,fg="#CC6600",bg="blue")
weight.config(font=("Lucida Console",20))
weight.grid(row=1,column=0)

nill1=Label(root,text="",borderwidth=4,bg="blue").grid(row=2,column=0,columnspan=5)

kg=Label(root,text="kgs",fg="#CC6600",bg="blue")
kg.config(font=("Lucida Console",13))
kg.grid(row=1,column=5)

height=Label(root,text="HEIGHT",borderwidth=15,fg="#CC6600",bg="blue")
height.config(font=("Lucida Console",20))
height.grid(row=3,column=0)

nill2=Label(root,text="",borderwidth=4,bg="blue").grid(row=4,column=0,columnspan=5)

slider=Scale(root,from_=20,to=120,orient=HORIZONTAL,bd=3,length=200,tickinterval=20,width=15,fg="#CC6600",bg="blue",troughcolor="blue")
...
clicked1.set(5)
feet_menu.config(bg="blue",fg="#FFFF99")
feet_menu.config(highlightbackground="#FFFF99")
feet_menu.grid(row=3,column=1)
feet=Label(root,text="feet",borderwidth=5,fg="#CC6600",bg="blue")
...
clicked2.set(5)
inch_menu.config(bg="blue",fg="#FFFF99")
inch_menu.config(highlightbackground="#FFFF99")
inch_menu.grid(row=3,column=3)
inch=Label(root,text="inches",borderwidth=5,fg="#CC6600",bg="blue")
...
def sub(w,h1,h2):
    ...
    a=(h1*12+h2)*0.0254
    result=float(w/(a*a))
    result_label=Label(new,text="YOUR BMI : "+str(round(result,2)),bg="blue",fg="#FFFF99")
    result_label.config(font=("Lucida Console",20))
    result_label.grid(row=0,column=0)
    if result<18.5:
        info_label=Label(new,text="YOU BELONG TO UNDERWEIGHT CATEGORY",bg="blue",fg="#FFFF99")
        info_label.config(font=("Lucida Console",15))
        info_label.grid(row=1,column=0)
    elif 18.5<=result<25:
        info_label=Label(new,text="YOU BELONG TO NORMAL WEIGHT CATEGORY",bg="blue",fg="#FFFF99")
        info_label.config(font=("Lucida Console",15))
        info_label.grid(row=1,column=0)
    elif 25<=result<30:
        info_label=Label(new,text="YOU BELONG TO OVER WEIGHT CATEGORY",bg="blue",fg="#FFFF99")
        info_label.config(font=("Lucida Console",15))
        info_label.grid(row=1,column=0)
    else:
        info_label=Label(new,text="YOU ARE OBESE..NEED TO BURN OUT A LOT!",bg="blue",fg="#FFFF99")
        info_label.config(font=("Lucida Console",15))
        info_label.grid(row=1,column=0)
